        ...
        <div class="container-fluid">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item" data-ride="true">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5 carousel-text" style="">
                                <h1>コンテンツを<br>
                                    選択して<br>
                                    “色”を決めるだけ</h1>
                    ...
                    <div class="carousel-item" data-ride="true">
                        <div class="row align-items-center">
                            <div class="col-lg-7 carousel-img" style="height: 100%; width: 100%;">
                            ...
                            <div class="col-lg-5 carousel-text">
                                <h1>読書の<br>
                                    わくわくに<br>
                                    新しいスタンダードを</h1>
                                <p><span>“本の共感覚化としての⾊覚化”
                                    </span><br>千年後、この⺠主的な『COLOR BOOK REVIEW』は当たり前<br>のように読者の判断基準の1つになっているのかも知れない。</p>
            ...
            <div class="typewrite" style="display: none;">
                ...
                <div class="loading3" style="display: none;">
                    ...
                    <p>本の共感覚化としての⾊覚化<br>
                        全く新しい情報だが、これが百年千年と続けば、<br>
                        リテラシーは、後から追い付いてくるのではないか<br>
                        千年後、この⺠主的な『COLOR BOOK REVIEW』は当たり前のように<br>

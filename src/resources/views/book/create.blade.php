            ...
            <form class="col-lg-6 color_palette" method="POST" action="/book/create/{{$book->id}}/store">
                ...
                <div class="row radio-tile-group mb-5">
                    <div class="col-lg-3 input-container">
                        <input id="walk" class="radio-button red" type="radio" name="color" value="linear-gradient(315deg, rgba(255,150,150,1) 0%, rgba(255,69,69,1) 100%)"/>
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="bike" class="radio-button pink" type="radio" name="color" value="linear-gradient(315deg, rgba(255,150,239,1) 0%, rgba(255,69,226,1) 100%)"/>
                        <div class="radio-tile"
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="drive" class="radio-button purple" type="radio" name="color" value="linear-gradient(315deg, rgba(198,150,255,1) 0%, rgba(155,69,255,1) 100%)"/>
                        <div class="radio-tile"
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="fly" class="radio-button navy" type="radio" name="color" value="linear-gradient(315deg, rgba(150,158,255,1) 0%, rgba(69,90,255,1) 100%)"/>
                        <div class="radio-tile"
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="walk" class="radio-button blue" type="radio" name="color" value="linear-gradient(315deg, rgba(150,211,255,1) 0%, rgba(69,183,255,1) 100%)"/>
                        <div class="radio-tile"
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="bike" class="radio-button skyBlue" type="radio" name="color" value="linear-gradient(315deg, rgba(150,255,243,1) 0%, rgba(69,255,234,1) 100%)"/>
                        <div class="radio-tile"
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="drive" class="radio-button green" type="radio" name="color" value="linear-gradient(315deg, rgba(150,255,166,1) 0%, rgba(69,255,98,1) 100%)"/>
                        <div class="radio-tile"
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="fly" class="radio-button lime" type="radio" name="color" value="linear-gradient(315deg, rgba(219,255,150,1) 0%, rgba(191,255,69,1) 100%)"/>
                        <div class="radio-tile"
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="walk" class="radio-button yellow" type="radio" name="color" value="linear-gradient(315deg, rgba(255,243,150,1) 0%, rgba(255,226,69,1) 100%)"/>
                        <div class="radio-tile"
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="bike" class="radio-button orange" type="radio" name="color" value="linear-gradient(315deg, rgba(255,190,150,1) 0%, rgba(255,133,69,1) 100%)"/>
                        <div class="radio-tile"
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="drive" class="radio-button black" type="radio" name="color" value="linear-gradient(315deg, rgba(85,85,85,1) 0%, rgba(17,17,17,1) 100%)"/>
                        <div class="radio-tile"
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="fly" class="radio-button white" type="radio" name="color" value="linear-gradient(315deg, rgba(250,250,250,1) 0%, rgba(240,240,240,1) 100%)"/>
                        <div class="radio-tile"

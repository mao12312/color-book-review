            ...
            <form class="col-lg-6 color_palette" method="POST" action="/author/create/{{$author->id}}/store">
                ...
                <div class="row radio-tile-group">
                    <div class="col-lg-3 input-container">
                        <input id="walk" class="radio-button" type="radio" name="color" value="#FF4545" />
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="bike" class="radio-button" type="radio" name="color"  value="#FF45E2" />
                        <div class="radio-tile"
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="drive" class="radio-button" type="radio" name="color" value="#9B45FF"/>
                        <div class="radio-tile"
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="fly" class="radio-button" type="radio" name="color" value="#455AFF"/>
                        <div class="radio-tile"
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="walk" class="radio-button" type="radio" name="color" value="#45B7FF"/>
                        <div class="radio-tile"
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="bike" class="radio-button" type="radio" name="color" value="#45FFEA"/>
                        <div class="radio-tile"
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="drive" class="radio-button" type="radio" name="color" value="#45FF62"/>
                        <div class="radio-tile"
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="fly" class="radio-button" type="radio" name="color" value="#BFFF45"/>
                        <div class="radio-tile"
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="walk" class="radio-button" type="radio" name="color" value="#FFE245"/>
                        <div class="radio-tile"
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="bike" class="radio-button" type="radio" name="color" value="#FF8545"/>
                        <div class="radio-tile"
                    ...
                    <div class="col-lg-3 input-container">
                        <input id="drive" class="radio-button" type="radio" name="color" value="#111111"/>
                        <div class="radio-tile"
